---
title: "Introduction of metabolomicsR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{metabolomicsR_intro}
...
```{r workflow, fig.align = 'center', out.width = "120%", out.height = "180%", echo = FALSE}

workflow <- system.file("extdata", "workflow.png", package = "metabolomicsR", mustWork = TRUE)
knitr::include_graphics(workflow)
