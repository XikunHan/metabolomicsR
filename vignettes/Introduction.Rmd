...
Figure: Seamless workflow to preprocess, analyze, and visualize metabolomics data in `{metabolomicsR}` <img src="../man/figures/workflow.png" align="center" width="120%" height="180%"/>
