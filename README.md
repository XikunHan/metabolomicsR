...
<img src="/n/home00/xikun/R/ifxrstudio/RELEASE_3_13/metabolomicsR/extdata/workflow.png" width="120%" height="180%" style="display: block; margin: auto;" />
...
#> 
#> ***  @logs  ***
#> 04/03/22 03:03:41: Import data from: /n/home00/xikun/R/ifxrstudio/RELEASE_3_13/metabolomicsR/extdata/QMDiab_metabolomics_OrigScale.xlsx .
#> 04/03/22 03:03:41: Initiate data: 356 samples and 758 features.
```
...
#> 04/03/22 03:03:41: Import data from: /n/home00/xikun/R/ifxrstudio/RELEASE_3_13/metabolomicsR/extdata/QMDiab_metabolomics_OrigScale.xlsx .
#> 04/03/22 03:03:41: Initiate data: 356 samples and 758 features.
#> 04/03/22 03:03:41: Update data, action: change_featureID, 356 samples and 758 features.
```
...
#> ***  @logs  ***
#> 04/03/22 03:03:41: Import data from: /n/home00/xikun/R/ifxrstudio/RELEASE_3_13/metabolomicsR/extdata/QMDiab_metabolomics_OrigScale.xlsx .
#> 04/03/22 03:03:41: Initiate data: 359 samples and 891 features.
#> 04/03/22 03:03:41: Update data, action: change_featureID, 359 samples and 891 features.
```
...
#> 
#> ***  @logs  ***
#> 04/03/22 03:03:42: Import data from: /n/home00/xikun/R/ifxrstudio/RELEASE_3_13/metabolomicsR/extdata/QMDiab_metabolomics_OrigScale.xlsx .
#> 04/03/22 03:03:42: Initiate data: 321 samples and 602 features.
#> 04/03/22 03:03:42: Update data, action: change_featureID, 321 samples and 602 features.
```
...
#> 04/03/22 03:03:41: Update data, action: change_featureID, 356 samples and 758 features. 
#> 
#> 04/03/22 03:03:42: Run QC pipeline.
#> 04/03/22 03:03:42: Filter data with a constant column, removed 37 features. 
#> 04/03/22 03:03:42: Update data, 356 samples and 758 features. 
#> 04/03/22 03:03:42: Filter data with a missing rate >= 0.5, removed 176 features. 
#> 04/03/22 03:03:42: Update data, 356 samples and 758 features.
```
...
#> 
#> 04/03/22 03:03:42: Run QC pipeline.
#> 04/03/22 03:03:42: Filter data with a constant column, removed 28 features. 
#> 04/03/22 03:03:42: Update data, 359 samples and 891 features. 
#> 04/03/22 03:03:43: Filter data with a missing rate >= 0.5, removed 77 features. 
#> 04/03/22 03:03:43: Update data, 359 samples and 891 features.
```
...
#> 04/03/22 03:03:42: Update data, action: change_featureID, 321 samples and 602 features. 
#> 
#> 04/03/22 03:03:43: Run QC pipeline.
#> 04/03/22 03:03:43: Filter data with a constant column, removed 35 features. 
#> 04/03/22 03:03:43: Update data, 321 samples and 602 features. 
#> 04/03/22 03:03:43: Filter data with a missing rate >= 0.5, removed 203 features. 
#> 04/03/22 03:03:43: Update data, 321 samples and 602 features.
```
...
#> 04/03/22 03:03:42: Filter data with a missing rate >= 0.5, removed 176 features. 
#> 04/03/22 03:03:42: Update data, 356 samples and 758 features. 
#> 04/03/22 03:03:53: Impute data using `half-min` method. 
#> 04/03/22 03:03:54: Transformation using `log` method. 
#> 04/03/22 03:03:54: Transformation using `scale` method.
```
